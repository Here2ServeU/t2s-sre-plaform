...
private_subnets    = ["120.0.1.0/24", "120.0.2.0/24"]
public_subnets     = ["120.0.3.0/24", "120.0.4.0/24"]
eks_cluster_name   = "t2s-eks-dev"
eks_version        = "1.27"
rds_instance_name  = "t2s-rds-dev"
rds_username       = "admin"
rds_password       = "T2S-SecurePassword-2025"
...
# vpc_cidr          = "120.0.0.0/16"
# availability_zones = ["us-east-1a", "us-east-1b"]
# private_subnets    = ["120.0.5.0/24", "120.0.6.0/24"]
# public_subnets     = ["120.0.7.0/24", "120.0.8.0/24"]
...
# private_subnets    = ["120.0.9.0/24", "120.0.10.0/24", "120.0.11.0/24"]
# public_subnets     = ["120.0.12.0/24", "120.0.13.0/24", "120.0.14.0/24"]
